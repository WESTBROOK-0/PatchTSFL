...
# Cell
class CIPatchTSF_backbone(nn.Module):
    def __init__(self, c_in: int, context_window: int, target_window: int, patch_len: int, stride: int,
        ...
        # Backbone
        self.backbone = TSFLiEncoder(c_in, context_window=context_window, patch_num=patch_num, patch_len=patch_len, moving_avg=moving_avg,
