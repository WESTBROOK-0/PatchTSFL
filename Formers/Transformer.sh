...
do
  ...
  python -u run_longExp.py \
      ...
      --c_out 321 \
      --des 'Exp' \
      --itr 1 >Transformerlogs/LongForecasting/$model_name'_electricity_'$pred_len.log
  ...
  python -u run_longExp.py \
    ...
    --des 'Exp' \
    --itr 1 \
    --train_epochs 3 >Transformerlogs/LongForecasting/$model_name'_traffic_'$pred_len.log
  ...
  python -u run_longExp.py \
      ...
      --c_out 7 \
      --des 'Exp' \
      --itr 1  >Transformerlogs/LongForecasting/$model_name'_Etth1_'$pred_len.log
  ...
  python -u run_longExp.py \
      ...
      --c_out 7 \
      --des 'Exp' \
      --itr 1  >Transformerlogs/LongForecasting/$model_name'_Etth2_'$pred_len.log
  ...
  python -u run_longExp.py \
      ...
      --c_out 7 \
      --des 'Exp' \
      --itr 1  >Transformerlogs/LongForecasting/$model_name'_Ettm1_'$pred_len.log
  ...
  python -u run_longExp.py \
      ...
      --c_out 7 \
      --des 'Exp' \
      --itr 1  >Transformerlogs/LongForecasting/$model_name'_Ettm2_'$pred_len.log
done
done
...
do
  python -u run_longExp.py \
    ...
    --c_out 7 \
    --des 'Exp' \
    --itr 1 >Transformerlogs/LongForecasting/$model_name'_ili_'$pred_len.log
done
done
