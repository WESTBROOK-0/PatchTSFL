...
do
    python -u run_longExp.py \
      ...
      --model_id exchange_rate_$seq_len'random_'$modes \
      --model $model_name \
      --data $data_name \
      --features M \
      --seq_len $seq_len \
      ...
      --train_epochs 100\
      --patience 20\
      --itr 1 --batch_size 128 --learning_rate 0.0001 >logs/LongForecasting/change_modes/$model_name'_'$model_id_name'_'$seq_len'random_'$modes.log
done
...
do
    python -u run_longExp.py \
      ...
      --root_path $root_path_name \
      --data_path $data_path_name \
      --model_id exchange_rate_$seq_len'low_'$modes \
      --model $model_name \
      --data $data_name \
      --features M \
      --seq_len $seq_len \
